<template>
  <div class="dashboard-layout">
    <aside class="sidebar">
      ...
      <nav class="menu">
        <router-link to="/NhanVien/dashboard" class="menu-item" active-class="active">
    ...
    <div class="main-wrapper">
      <header class="navbar">
         <div class="search-box">
          ...
          <input type="text" placeholder="Tìm tên khách, số phòng..." />
        </div>
        <div class="user-actions">
          <div class="avatar">
            <img src="https://i.pravatar.cc/150?img=32" alt="Staff" />
          </div>
        </div>
      </header>
